  ...
  return (
    <div className="fixed bottom-6 right-20 z-[99] flex flex-col items-end gap-2">
      ...
      <AnimatePresence>
        {showNudge && (
          <motion.div
            ...
            className="bg-slate-900 text-white text-xs font-semibold px-3.5 py-2 rounded-xl shadow-lg max-w-[180px] text-center leading-relaxed pointer-events-none"
          >
      ...
      <motion.button
        ...
        type="button"
        onClick={onOpen}
        className="flex items-center gap-2.5 p-1.5 pe-5 rounded-full bg-white text-slate-900 border border-slate-200 shadow-[0_10px_25px_rgba(0,0,0,0.1)] hover:shadow-[0_15px_35px_rgba(0,0,0,0.15)] hover:border-slate-300 transition-colors duration-300 focus:outline-none"
